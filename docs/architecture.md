...
- **transaction-scorer** — Consumes txn.raw, computes velocity features, applies the rule engine and ML
  score, publishes to txn.scored
- **alert-orchestrator** — Consumes txn.scored above threshold, deduplicates, opens or updates a case,
  publishes txn.alerted
